...
#include "Player.h"
/*
ВНИМАНИЕ!!!! Если игра(точнее кусок игры) работет визуально некорректно, 
то необходимо поставить шрифт Consolas в блокноте и в консоли, 
полный экран, размер шрифта в консоли 18 и размер буфера экрана в консоли должен быть 1000x1000. 
*/
///////////////////////////////////////////////////////////////////////////////////////
